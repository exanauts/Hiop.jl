...
function get_sparse_dense_blocks_info_wrapper(nx_sparse_::Ptr{Cint}, nx_dense_::Ptr{Cint},
                                              nnz_sparse_Jaceq_::Ptr{Cint},
                                              nnz_sparse_Jacineq_::Ptr{Cint},
...
function eval_f_wrapper(n::Clonglong, x_ptr::Ptr{Float64},
                        new_x::Cint, obj_ptr::Ptr{Float64}, prob_::Ptr{Cvoid})
...
# Constraints (eval_g)
function eval_g_wrapper(n::Clonglong, m::Clonglong,
                        x_ptr::Ptr{Float64}, new_x::Cint, g_ptr::Ptr{Float64},
                        user_data::Ptr{Cvoid})
    # Extract Julia the problem from the pointer
...
function eval_grad_f_wrapper(n::Clonglong, x_ptr::Ptr{Float64},
                             new_x::Cint, grad_f_ptr::Ptr{Float64},
                             user_data::Ptr{Cvoid})
    # Extract Julia the problem from the pointer
    prob = unsafe_pointer_to_objref(user_data)::HiopProblem
...
function eval_jac_g_wrapper(n::Clonglong, m::Clonglong,
                            x_ptr::Ptr{Cdouble}, new_x::Cint,
                            nsparse::Clonglong, ndense::Clonglong,
                            nnzJacS::Cint, iJacS_ptr::Ptr{Cint},
                            jJacS_ptr::Ptr{Cint}, MJacS_ptr::Ptr{Cdouble},
                            JacD_ptr::Ptr{Cdouble}, user_data::Ptr{Cvoid})
    # Extract Julia the problem from the pointer
    prob = unsafe_pointer_to_objref(user_data)::HiopProblem
    # Determine mode
    mode = Vector{Symbol}()
...
function eval_h_wrapper(n::Clonglong, m::Clonglong,
                        ...
                        nsparse::Clonglong, ndense::Clonglong,
                        nnzHSS::Cint, iHSS_ptr::Ptr{Cint},
                        jHSS_ptr::Ptr{Cint}, MHSS_ptr::Ptr{Cdouble},
                        HDD_ptr::Ptr{Cdouble},
                        nnzHSD::Cint, iHSD_ptr::Ptr{Cint},
                        jHSD_ptr::Ptr{Cint}, MHSD_ptr::Ptr{Cdouble},
                        user_data::Ptr{Cvoid})
    # Extract Julia the problem from the pointer
    prob = unsafe_pointer_to_objref(user_data)::HiopProblem
    # Determine mode
